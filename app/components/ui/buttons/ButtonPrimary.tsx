        ...
        if (!to || disabled) {
          ...
          return (
            <Link
              ...
              className={clsx(
                className,
                "inline-flex items-center space-x-2 px-4 py-2 border border-1-transparent shadow-sm text-sm font-medium rounded-md text-black focus:outline-none ",
                disabled && "cursor-not-allowed opacity-75",
                !destructive && "bg-[#F7BE38]",
                destructive && "bg-red-600",
                !disabled && !destructive && "hover:bg-[#FEB400] focus:ring-accent-500 hover:text-accent-800",
                !disabled && destructive && "hover:bg-red-700 focus:ring-red-500"
              )}
            >
              {children} 
