...
export default function InfoBanner({ title = "Note", text = "", redirect, children }: Props) {
  ...
  return (
    <div className="bg-theme-50 rounded-md border border-theme-300 not-prose">
      <div className="rounded-md p-4">
        <div className="flex">
          ...
          <div className="ml-3 w-full">
            <h3 className="text-sm leading-5 font-medium text-theme-900">{title}</h3>
            <div className="mt-2 text-sm leading-5 text-theme-800">
              <div>
                {text}{" "}
                {redirect && (
                  <Link className="mt-2 underline text-theme-900" to={redirect}>
