            ...
            if (!emailSent) {
              return (
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                  <h2 className="mt-6 text-center text-lg font-extrabold text-gray-800 dark:text-slate-200">Forgot your password?</h2>
                  <p className="mt-5 text-sm leading-5 text-center text-gray-500">Reset your password</p>
                      ...
                      <div className="relative">
                        ...
                        <div className="relative flex justify-center text-sm leading-5">
                          <span className="px-2 bg-white dark:bg-slate-900 text-gray-500">
                            If you mistakenly visit this page
                          </span>
                        </div>
                      </div>
                ...
                <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                  <div className="max-w-md w-full mx-auto rounded-sm px-8 pt-6 pb-8 mb-4 mt-8">
                    <h2 className="text-xl font-black">
                      <h2 className="mt-6 text-center text-lg font-extrabold text-gray-800 dark:text-slate-200">Check your email</h2>
                    </h2>
                    <div className="my-4 leading-tight">
                      <p className="mt-2 text-center text-sm leading-5 text-gray-900 dark:text-slate-300 max-w">A password reset link sent to your email</p>
                    </div>
                  </div>
                </div>
              );
