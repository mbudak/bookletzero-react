          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="sm:flex sm:flex-col sm:align-center space-y-4">
              <div className="text-gray-500 prose mx-auto">
                ...
                <p>
                  Your privacy is important to us. It is BookletZero&#39; policy to respect your privacy and comply with any applicable law and regulation
                  regarding any personal information we may collect about you, including across our website,{" "}
                  <a className="text-black dark:text-white" href="https://bookletzero.com">
                    https://bookletzero.com
                  </a>
